...
module.exports = function(opts, callback) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (res.userid && res.password && fname.search('http') === 0) {
        ...
        if (fname.search('http') === 0) {
          ...
          inline({fname: fname, cssUrlReplacer: res.cssUrlReplacer, inlineContent: inlineContent})
          .then(function(src) {
  ...
  if (typeof opts.inline === 'function') {
    inline = opts.inline; // using code is supplying own inliner
    delete opts.inline;
